            ...
            <div className="container mx-auto px-4 relative z-10 max-w-5xl">
                ...
                <div className="max-w-3xl mx-auto space-y-4">
                    ...
                    <FAQItem
                        ...
                        answer="ในหลักเลขศาสตร์ไทย คู่เลขแบ่งเป็น 4 ประเภทตามดาวพระเคราะห์ ได้แก่ (1) คู่มิตร เช่น 15/51, 24/42, 36/63, 78/87 — ส่งเสริมเกื้อกูลกัน ดึงดูดโชคลาภ (2) คู่สมพล เช่น 16/61, 28/82, 35/53, 49/94 — เสริมพลังอำนาจและบารมี (3) คู่ธาตุ เช่น 17/71 (ไฟ), 28/82 (ดิน), 39/93 (ลม), 46/64 (น้ำ) — ส่งเสริมความมั่นคง (4) คู่ศัตรู เช่น 13/31, 48/84, 67/76 — ส่งผลลบ ควรหลีกเลี่ยง"
                    />
                </div>
            </div>
