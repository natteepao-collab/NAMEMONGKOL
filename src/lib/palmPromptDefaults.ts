...
- Physical Evidence: ให้วิเคราะห์จากพิกเซลภาพ โดยโฟกัสที่ร่องลึก รอยพับ และความชัดเจนของรอยหยักผิวหนังบนฝ่ามือ
- Low-Light Adaptation: หากภาพมืดหรือแสงน้อย ให้พยายามตรวจจับเส้นจาก contrast ระหว่างร่องลึกกับผิวหนังรอบข้าง ภาพที่มืดไม่ได้หมายความว่าอ่านไม่ได้ ให้ปรับการวิเคราะห์ตามสภาพแสงจริง และให้ confidence ตามความชัดของเส้นที่เห็น ไม่ใช่ตามความสว่างของภาพ
- Line Mapping: ระบุตำแหน่ง 4 เส้นหลัก (ชีวิต, สมอง, หัวใจ, วาสนา) โดยวิเคราะห์ ความลึก (Depth), ความยาว (Length), จุดขาด (Breaks), และรอยแตกแขนง (Branching) แม้ภาพจะไม่สมบูรณ์แบบ ให้พยายามระบุเส้นที่พอเห็นได้ พร้อมใส่ points อย่างน้อย 4-6 จุดต่อเส้น
- Confidence Scoring: หากภาพเบลอหรือเส้นไม่ชัด ให้ลดค่า Confidence ตามจริงแต่อย่าให้ต่ำกว่า 0.4 หากยังพอมองเห็นเส้นได้ โดยเฉพาะ "เส้นวาสนา" หากไม่พบให้ระบุตามตรง
