...
const dayCollections = [
    ...
    { day: 'วันพุธ(กลางวัน)', name: 'วาจาเรียกทรัพย์', color: 'from-emerald-500 to-green-500', textColor: 'text-emerald-400', borderColor: 'border-emerald-500/30', bgColor: 'bg-emerald-500/10', icon: MessageCircle, desc: 'เหมาะสำหรับนักธุรกิจ นักขาย และผู้ที่ต้องใช้การสื่อสารเป็นหลัก เสริมวาจาศักดิ์สิทธิ์ พูดจาน่าเชื่อถือ ค้าขายร่ำรวย' },
    { day: 'วันพุธ(กลางคืน)', name: 'ราหูคุ้มครอง', color: 'from-slate-500 to-gray-700', textColor: 'text-slate-300', borderColor: 'border-slate-500/30', bgColor: 'bg-slate-500/10', icon: Moon, desc: 'เสริมพลังราหู ป้องกันภัยอันตราย แคล้วคลาดจากเคราะห์ร้าย เหมาะสำหรับผู้ที่ต้องเดินทางกลางคืน ทำงานกะดึก หรือต้องการเสริมดวงด้านความปลอดภัย' },
