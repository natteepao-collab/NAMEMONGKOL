...
const DAY_META: Record<string, { label: string; desc: string; keywords: string[] }> = {
    ...
    wednesday: {
        ...
        desc: 'วอลเปเปอร์มงคลสำหรับคนเกิดวันพุธกลางวัน เสริมวาจาเรียกทรัพย์ ค้าขายร่ำรวย สีมงคลเขียว ออกแบบตามหลักฮวงจุ้ย',
        keywords: ['วอลเปเปอร์วันพุธ', 'วอลเปเปอร์วันพุธกลางวัน', 'สีมงคลวันพุธ', 'เสริมดวงวันพุธ'],
    },
    wednesday_night: {
        label: 'วันพุธ(กลางคืน)',
        desc: 'วอลเปเปอร์มงคลสำหรับคนเกิดวันพุธกลางคืน เสริมพลังราหู ป้องกันภัย แคล้วคลาด สีมงคลเทาดำ ออกแบบตามหลักโหราศาสตร์ไทย',
        keywords: ['วอลเปเปอร์วันพุธกลางคืน', 'เสริมดวงวันพุธกลางคืน', 'วอลเปเปอร์ราหู', 'สีมงคลวันพุธกลางคืน'],
    },
    thursday: {
        label: 'วันพฤหัสบดี',
