...
export const metadata: Metadata = {
    ...
    description: 'NameMongkol แพลตฟอร์มวิเคราะห์ชื่อมงคลอันดับ 1 ของไทย ผสานศาสตร์โบราณ 4 แขนง เข้ากับ AI พร้อมเช็คเบอร์มงคลฟรี วิเคราะห์ลายมือออนไลน์ ช่วยตั้งชื่อลูก เปลี่ยนชื่อเสริมดวง',
    keywords: 'เกี่ยวกับ NameMongkol, ตั้งชื่อมงคล, วิเคราะห์ชื่อ, ดูดวงชื่อ, เลขศาสตร์, ทักษาปกรณ์, อายตนะ 6, ชื่อมงคล, เปลี่ยนชื่อ, ตั้งชื่อลูก, เช็คเบอร์มงคล, วิเคราะห์เบอร์โทรศัพท์, วิเคราะห์ลายมือ, วิเคราะห์ลายมือออนไลน์, ดูดวงลายมือ, เส้นชีวิต, เส้นสมอง, เส้นหัวใจ, นิรันดร์ศาสตร์, ชื่อดีเป็นศรีแก่ตัว',
    openGraph: {
        title: 'เกี่ยวกับเรา | NameMongkol วิเคราะห์ชื่อ เบอร์ ลายมือ',
