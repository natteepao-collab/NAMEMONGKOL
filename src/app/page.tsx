...
export async function generateMetadata(
  ...
  if (!name) {
    return {
      title: 'วิเคราะห์ชื่อมงคลฟรี แม่นยำที่สุด 2568: เช็คพลังเงาและเลขศาสตร์ | NameMongkol',
      description: 'วิเคราะห์ชื่อฟรีด้วยระบบ AI แม่นยำที่สุด! ตรวจสอบชื่อ-นามสกุลตามหลักเลขศาสตร์ ทักษาปกรณ์ และอายตนะ 6 "เปลี่ยนชื่อ เปลี่ยนชีวิต" รู้ทันดวงชะตาเศรษฐีทันที',
      openGraph: {
        title: 'วิเคราะห์ชื่อมงคลฟรี แม่นยำที่สุด: เช็คพลังเงาและเลขศาสตร์',
        description: 'วิเคราะห์ชื่อฟรีด้วยระบบ AI แม่นยำที่สุด! "เปลี่ยนชื่อ เปลี่ยนชีวิต" ตรวจสอบชื่อ-นามสกุลตามหลัก 4 ศาสตร์ศักดิ์สิทธิ์',
        images: [`${siteUrl}/api/og?variant=default&title=วิเคราะห์ชื่อมงคลฟรี&subtitle=แม่นยำที่สุด%20ด้วยระบบ%20AI%20อัจฉริยะ`],
      }
    }
  }
