...
export default function PrivacyPage() {
    return (
        <div className="min-h-screen bg-[#0f172a] text-slate-200 relative overflow-hidden">
            ...
            <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 md:pt-32 pb-12 md:pb-20">
                {/* Navigation */}
                <Link
                    href="/"
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="space-y-3">
                                    {[
                                        ...
                                        { title: 'ข้อมูลการใช้งาน', desc: 'ประวัติการวิเคราะห์ชื่อ, การค้นหาชื่อมงคล และการดาวน์โหลดวอลเปเปอร์' },
